...
export default function TitleBar({ scrollY }: { scrollY: number }) {
  //hiding title Bar functionality
    ...
    <Fragment>
      {expandTitleBar ? (
        <div
          ...
          onClick={() => setExpandTitleBar(false)}
        ></div>
      ) : null}
          ...
          {showTitleBar ? (
            ...
            >
              <motion.div
                ...
                // needed because layout breaks framer animations on mobile (so deactivating it for small screen sizes)
              >
                <Link className="titleBarLeft" href="/">
                  <div className="barLogoContainer">
                    <svg
                  ...
                  <span className="barLogoText">Glace</span>
                </Link>
                <motion.div
                  className="barAboutButton button"
                  onClick={() => setExpandTitleBar(!expandTitleBar)}
                >
                  about us
                </motion.div>
              </motion.div>
              {expandTitleBar ? (
                ...
                >
                  <motion.p className="titleBarP">
                    This is our final major project within the MA User
                    Experience Design at the University of the Arts London.
                    {/* If you are interested to
                    support us making this project become real, get in touch on
                    test@getglace.com */}
                  </motion.p>
