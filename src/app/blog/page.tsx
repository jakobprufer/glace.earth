...
import { RiNotionFill, RiArrowDownSLine } from "react-icons/ri";
...
import Oldice from "../../../public/blog/oldice.webp";
import Oldice2 from "../../../public/blog/oldice2.webp";
  ...
  return (
    <div className="blogCont">
      ...
      <div className="blog">
        ...
        {/* <p className="intro">
          Notice: some of the later phases overlap as we worked on them
          simultaneously.
        </p> */}
        <motion.section
          layout
          ...
          {s1Open ? (
            ...
            >
              ...
              <p>
                ...
                briefs throughout this MA the direction was anything but obvious
                initially.
              </p>
              ...
              <p>
                We discussed a number of topics we ended up not pursuing. Those
                included:
              </p>
              <ul>
                <li>
                ...
                <li>
                  Creating a service through which people with spare rooms in
                  cities could give creatives a temporary homestay in exchange
                  for their specific skills, applied in collaborative work, or
                  their works of art
                </li>
                <li>
                  Designing a system of waste-free takeout packaging that could
                  be returned in collection stations across offices and
                  universities
                </li>
              </ul>
              ...
              <p>
                ...
                leaving people feeling largely overwhelmed by the issue. So we
                decided to approach it from a different angle.{" "}
              </p>
              <p>
          ...
          {s2Open ? (
            ...
            >
              <div className="blogCaption">
                <b>Image:</b> A picture generated using the AI tool Midjourney
              ...
              <p>
                ...
                fascinating to me, such as{" "}
                <a href="https://lanzatech.com/" target="_blank">
                  <b>LanzaTech</b>
                </a>{" "}
                who transform captured carbon into fuels, chemicals and clothing
                or{" "}
              ...
              <p>
                ...
                investment sustainability, a critical aspect for the project if
                we wanted to have any credibility for actual impact. We
                discovered controversies surrounding existing instruments like
                ESG ratings, criticized for arbitrariness and bureaucratic
                complexity. However, we found a growing industry seeks to
                enhance the reliability and trustworthiness of sustainability
                ratings. Firms include{" "}
                ...
                alignment with the UN Sustainable Development Goals and tracking
                CO2 emission. It also provides a nuanced evaluation of portfolio
                impact, visualizing it in tangible measures such as equivalent
                flights saved or equivalent household water consumption saved.
              </p>
              ...
              <p>
                Generation Z, born between 1995 and 2010, constitutes around 26%
                of the global population. They are distinguished by their status
                as digital natives immersed in the internet, mobile technology,
                apps, and social networks. Research confirmed our initial
                impression that this generation was generally more active in
                sustainable behaviors and willing to pay more for eco-friendly
                products.
              </p>
              <p>
              ...
              <ul>
                <li>
                  ...
                  spending on technological and design-based innovations in the
                  marketplace
                </li>
                <li>
                  <b>Insistence on convenience:</b> reliance on convenience,
                  seen in preferences for time-saving devices, easy-to-acquire
                  retail channels, and products with simplified experiences
                </li>
                <li>
        ...
        >
          ...
          {s3Open ? (
            ...
            >
              <p>
                We then commenced generative research to give us food for ideas
              ...
              <p>
                ...
                geographical scope with the intended target market of the
                platform. Within this limitation, however, we aimed to maximize
                diversity in ethnicity, educational background, gender,
                occupation. We also picked individuals with varying
              ...
              <p>
                ...
                quantitively with a survey but decided to move the survey to a
                later date after submission because of time restrictions.
              </p>
              ...
              <p>
                ...
                with 8 participants, of equal parts male and female and of five
                different nationalities. Responses were generally very good,
                with interviews ranging from 20-45 minutes in length. We
                transcribed the recordings and, if necessary, translated the
                transcripts. To access the transcripts and the full list of
                interview questions, see our Notion{" "}
                <a
                  href="https://www.notion.so/manfredidesign/Generative-User-Research-Interviews-a018eb1dc4a94b8a92de43cbb1c9c62e?pvs=4"
                  target="_blank"
                >
              ...
              <div className="blogCaption">
                ...
                analysis - then mapping emergent themes and sorting by affinity.
                We enjoyed doing this in a physical form even though AI-driven
                analysis tools might have done it faster.
              </div>
              ...
              <ol>
                ...
                <li>
                  <h4>
                    What can move Generation Z to translate ambitions/concerns
                    into action?
                  </h4>
                  <ul>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      sustainable investing as a method to tackle climate change
                    </li>
                  </ul>
                </li>
                <li>
        ...
        >
          ...
          {s4Open ? (
            ...
            >
              ...
              <p>
                We now started putting together the pieces from the background
                and generative research. To narrow down our focus we decided we
                would
              </p>
              <ul>
                <li>
              ...
              <p>
                A key insight from the financial research was the realization
                that my interest in investments grew only after grasping the
                underlying concepts. We recognized that many unfamiliar terms
                might seem uninteresting to those with little knowledge. Our
                initial concept, therefore, centered around an automated
                portfolio. This would be crafted based on user-friendly
                settings, resembling a robo-advisor. My vision for this was a
                clear settings page with a number of sliders and options to set
                preferences in sustainability targets, financial risk and focus.
                You would then be able to see a live updated overview of the
                automatically created mix of assets and the corresponding
                impact. Our financial investigation had indicated that
                establishing such an automated portfolio would be more feasible
                with funds rather than individual company stocks, so we decided
                to base the app on sustainably-focused funds.
              </p>

              <p>
                There were differences in opinion regarding certain settings. I
                believed it made sense to align with the format used by
                established wealth platforms in presenting financial information
                and to incorporate a risk element, allowing users to select
                their preferred level of risk for their portfolio. On the
                contrary, Manfredi preferred minimal user involvement, aiming
                for simplicity. This trend persisted throughout the project,
                with me advocating for user customizability and experimentation
                as a key part of the experience, while Manfredi aimed for a
                streamlined and minimalistic approach with a focus on clarity.
              </p>
              <Image
                src={Sketches}
              ...
              <p>
                ...
                ideas involved centering the app fully on a map view, showing
                water rise and consequent streams of refugees. Another idea was
                showing satellite-style animations of river deltas and
                coast-lines that would change depending on the level of impact.
                We also considered fully abstracted, Refik-Anadol-Style particle
                animations, for example to visualize CO2 emissions or
                international flights taken. We had set ourselves a tough
                challenge: finding a visualization that gave a clear message,
                could represent the impact of small-scale investments and would
                still send a strong message.
              </p>

              <p>
                Feedback in our tutorial was mixed. While the course team
                appreciated the depth of our research, they questioned the
                feasibility of the data visualization. While they could envision
                the creation of a visually appealing output, they sought a
                clearer comprehension of the tangible impact sizes, which was
                still unclear to us at that point. The team emphasized the
                importance of understanding and articulating the real-world
                implications of our work, urging us to delve deeper into the
                practical aspects to substantiate possible data sources.
              </p>
            </motion.div>
          ) : null}
        </motion.section>
          ...
          {s5Open ? (
            ...
            >
              ...
              <p>
                ...
                possible impact of our project Initially, I had been striving to
                obtain access to data providers like Clarity AI as we had been
                making assumptions about impact sizes. However, Manfredi was
                hesitant, considering the considerable effort it would take to
                connect with and apply for full access from one of these
                providers. A pivotal moment occurred when we delved deeper into
                the issue and discovered the possibility of calculating some of
                this data ourselves. Using platforms such as fossilfreefunds.org
                and the publicly available Clarity Check from Clarity AI, we
                were able to conduct a comparative analysis of the financed
                emissions of various funds, including those earmarked as our
                selected green funds. Based on the data we found, we would
                assume an average reduction of 40 - 100g CO2 per 1 Dollar
                invested in our portfolio. The benchmark for this reduction is
              ...
              <p>
                We also found scientific literature on CO2 emissions caused by
                other everyday behaviors such as living car-free, eating a
                plant-based diet or using a reusable shopping bag, enabling us
                to compare the investment impact to tangible actions.
              </p>
              ...
              />
              <div className="blogCaption">
                <b>Drawings for the prompt:</b> If CO2 Emissions were an object,
                what would they be?
              </div>
              <Image
                src={Drawing2}
              ...
              />
              <div className="blogCaption">
                <b>Drawings for the prompt:</b> What could be one consequence of
              ...
              <h3>Balloons as visualisation</h3>
              <Image
                src={Balloons}
                alt="A research paper and the interface of the Carity AI platform"
                className="blogImg"
              />
              <p>
                One possibility was to visualize the area of CO2 saved in the
                equivalent number of balloons filled with CO2. The estimates of
                CO2 per 0.5 cubic foot balloon (a standard size for a party
                balloon) range from 28g to 30g.
              </p>
              ...
              <p>
                ...
                example users with different investments, the visualization
                could be:
              </p>
              ...
              <p>
                ...
                medium. To calculate the amount of ice melted per CO2 emitted,
                we can refer to a 2016 Science-published paper by Notz &
                Stroeve, that establishes the relationship of 3 square meters
                melting with every 1 ton of CO2 emitted. This is equivalent to 3
                square millimeters per 1g CO2 or 30 sq cm per 1 kg CO2.
              </p>

              <p>
                Based on this, we would show the user the following amount of
                ice they saved, as shown with the same example users:
              </p>
        ...
        >
          ...
          {s6Open ? (
            ...
            >
              ...
              <Image src={Wire1} alt="Wireframe sketch" className="blogImg" />
              <Image src={Wire2} alt="Wireframe sketch" className="blogImg" />
              <Image src={Wire3} alt="Wireframe sketch" className="blogImg" />
              {/* <div className="blogCaption">
              ...
              <p>
                ...
                highlight the impact, while the second screen focused on viewing
                and managing the portfolio composition. The third screen could
                be used to show multiple portfolios/wallets and settings.
                Although we briefly considered adding an inbox for notifications
                as a fourth tab, we ultimately dismissed the idea. Another
                significant decision was to streamline the user experience by
                having only one portfolio per user, instead of multiple
                wallets/portfolios.
              </p>
              ...
              <ul>
                <li>
                  Adjust settings and observe real-time changes in the portfolio
                  reflected on the wheel.
                </li>
                <li>
              ...
              <p>
                ...
                envisioned sliders to set risk and sustainability preferences,
                to give users a feeling of ownership of their own customized
                portfolio while Manfredi favored simplicity. He liked the idea
                of chips that you could tap to select your favored
                sustainability goals – or perhaps in offering just a single
                portfolio without any customization choices.
              </p>
              <Image src={Marta} alt="Ice visualisations" className="blogImg" />
              <div className="blogCaption">
                <b>Image:</b> Notes from the first moderated testing session.
              </div>
              <p>
                In a first moderated testing session, we assessed the low
                fidelity prototype with some trial participants. We found that
                our initial color scheme with a dark background was not
                perceived as trustworthy for a financial product. Furthermore,
                we found a disconnect between the user choices and the portfolio
                composition. We would have to find a way to communicate that the
                allocation of funds was based on the user choices. The way we
                had planned the portfolio pie chart turned out not to be very
                understandable. We would have to provide additional affordance
                cues simplify the interaction.
              </p>
            </motion.div>
          ) : null}
        </motion.section>
        ...
        >
          ...
          {s7Open ? (
            ...
            >
              ...
              <p>
                We then focused on crafting a compelling narrative for Glace.
                Opting for an attention-grabbing website, we first hook viewers
                by quantifying everyday behaviour changes that could save a
                specific amount of Arctic ice. Glace is then presented as a
                solution to also influence the behaviour of big corporations. We
                guide visitors through mock-ups and bring the app to life on the
                website directly.
              </p>
              <Image
                src={Vscode}
              ...
              <p>
                ...
                HTML and SASS, incorporating Framer Motion for animated
                interactions.
              </p>
              <p>
          ...
          {s8Open ? (
            ...
            >
              <p>
                ...
                inside the application. Our goal was to create a visualization
                that:
              </p>
              <ul>
                <li>
              ...
              <p>
                ...
                showcase the size of saved ice. Users could place their virtual
                ice sheets in their natural surroundings. In this, we felt
                inspired by the work of Mariele Neudecker, a UK-based German
                artist who frequently uses glacier-like landscapes in her work.
                What fascinated us was her ability to take natural organic
              ...
              <p>
                ...
                maintain an in-app visual representation of ice on the screen.
                Our objectives for this version were to:
              </p>
              <ul>
                <li>
              ...
              <p>
                ...
                change the timespan or play around with crowd sizes for communal
                impact? Should they be able to compare Glace financial impact to
        ...
        >
          ...
          {s9Open ? (
            ...
            >
              <p>
                We could combine the prototype advances we had made during the
                low fidelity phase and build our final high-fidelity prototype
                in Figma. We decided against a three tab structure and instead
                let users access the three main parts of the app, impact
                visualisation, portfolio overview and shareable QR code right
                from the home page. We also added the planned article section
                right below on the home screen. Articles include deep-dives into
                the companies which the chosen funds invest in as well as
                introductory series to learn about finance and sustainability.
                We kept the portfolio section and its settings as simple as
                possible, but maintained a classic doughnut chart and line graph
                for financial transparency. The idea was to allow those keen to
                find out to go as deep as they liked into the details of the
                investment, while maintaining a simplicity on the top level for
              ...
              <p>
                We were able to test the first high fidelity version with some
                participants, giving them prompts to access specific functions
                of the app and documenting their thoughts and confusions through
                the thinking-out-loud method. The feedback ranged from small
                details like font sizes to larger issues such as persisting lack
                of connection between the user settings and the final portfolio
                outcome. The latter we managed to bridge by implementing icons
                also in the portfolio view, reminding users about the choices
                that lead to those funds being included. Based on further
                testing, we clarified some of the options in the settings page
                and we moved a list of all funds on a separate tab in the
