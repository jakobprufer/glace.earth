...
export default function Home() {
  ...
  useEffect(() => {
    ...
    console.log(`Distance from the top of the viewport: ${top}px`);
  }, []);
        ...
        {allLoaded ? (
          <div>
            ...
            <div className="fifthSection" id="fifthSection">
              ...
              <Image
                src={smallScreen ? BearsMobile : Bears}
                style={{
                  transform: `scale(${1 + (scrollY - 2300) / 5000})`,
                }}
              ...
              <div className="fifthSectionText medText">
                ...
                >
                  By this we mean the{" "}
                  <span className="lighthigh">surface of ice</span> as seen from
                  a satellite image - we can calculate this based on{" "}
                  ...
                  {expandSources ? (
                    ...
                    >
                      ...
                      <motion.a href="https://www.science.org/doi/10.1126/science.aag2345">
                        Notz, D. and Stroeve, J., 2016. Observed Arctic sea-ice
                        loss directly follows anthropogenic CO2
                      ...
                      <motion.a href="https://iopscience.iop.org/article/10.1088/1748-9326/aa7541?dom=translatable&src=syn">
                        ...
                        mitigation gap: education and government recommendations
                        miss the most effective individual actions.
                        Environmental Research Letters, 12(7), p.074024.
                      </motion.a>
                    </motion.div>
                  ) : null}
                </motion.div>
            ...
            <div className="sixthSection medText">
              <motion.p
                ...
                transition={{ duration: 1, ease: easeInOut }}
              >
                But even if we all change our habits, we know the big pollution
              ...
              <motion.p
                ...
                transition={{ duration: 1, ease: easeInOut }}
              >
                Well - we can influence this too - by choosing{" "}
                <span className="lighthigh">
                  whether to finance them or not.
                </span>
              </motion.p>
            </div>
            <motion.div
